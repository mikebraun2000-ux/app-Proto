#!/usr/bin/env python3
"""
Erstellt eine Datenbank mit einem definitiv funktionierenden Hash.
"""
...
def create_simple_working_db():
    """Erstellt eine Datenbank mit einem definitiv funktionierenden Hash."""
    print("Erstelle Datenbank mit funktionierendem Hash...")
    
    # Lösche alte Datenbank
    db_name = "database_simple_working.db"
    ...
    with Session(engine) as session:
        # Erstelle Benutzer mit einem definitiv funktionierenden bcrypt-Hash
    ...
    print("=" * 60)
    print("Datenbank mit funktionierendem Hash erstellt!")
    print()
    ...
    print("   Passwort: admin123")
    print()
    print("Die neue Datenbank ist: database_simple_working.db")
    print("Kopieren Sie diese ueber database.db um sie zu verwenden!")

if __name__ == "__main__":
    create_simple_working_db()
