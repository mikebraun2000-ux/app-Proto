#!/usr/bin/env python3
"""
Korrigiert die Passwort-Hashes mit einem bekannten funktionierenden bcrypt-Hash.
"""
...
def fix_login_simple():
    ...
    with Session(engine) as session:
        # Verwende einen bekannten funktionierenden bcrypt-Hash für "admin123"
        # Dieser Hash wurde mit bcrypt generiert und funktioniert
