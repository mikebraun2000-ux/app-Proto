#!/usr/bin/env python3
"""
Erstellt eine einfache Datenbank mit funktionierenden Hashes.
"""
...
def create_simple_database():
    """Erstellt eine einfache funktionierende Datenbank."""
    print("Erstelle einfache Datenbank...")
    
    # Lösche alte Datenbank
    db_name = "database_simple.db"
    ...
    with Session(engine) as session:
        # Erstelle Benutzer mit einem einfachen Hash
    ...
    print("=" * 60)
    print("Einfache Datenbank erstellt!")
    print()
    ...
    print("   Passwort: admin123")
    print()
    print("Die neue Datenbank ist: database_simple.db")
