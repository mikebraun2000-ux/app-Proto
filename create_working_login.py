#!/usr/bin/env python3
"""
Erstellt eine Datenbank mit definitiv funktionierenden bcrypt-Hashes.
"""
...
def create_working_login():
    """Erstellt eine Datenbank mit funktionierenden Login-Hashes."""
    print("Erstelle Datenbank mit funktionierenden Login-Hashes...")
    ...
    print("=" * 60)
    print("Datenbank mit funktionierenden Login-Hashes erstellt!")
    print()
    ...
    print("   Passwort: admin123")
    print()
    print("Die neue Datenbank ist: database_login.db")
