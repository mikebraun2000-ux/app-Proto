#!/usr/bin/env python3
"""
Erstellt eine funktionierende Datenbank mit korrekten bcrypt-Hashes.
"""
...
def create_working_database():
    """Erstellt eine funktionierende Datenbank."""
    print("Erstelle funktionierende Datenbank...")
    
    # Lösche alte Datenbank
    db_name = "database_working.db"
    ...
    with Session(engine) as session:
        # Erstelle Benutzer mit einem bekannten funktionierenden bcrypt-Hash
    ...
    print("=" * 60)
    print("Funktionierende Datenbank erstellt!")
    print()
    ...
    print("   Passwort: admin123")
    print()
    print("Die neue Datenbank ist: database_working.db")
